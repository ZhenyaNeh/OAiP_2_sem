...
/*Ввести массивы А и В. В массив С перенести нечетные элементы массива А и четные элемента массива В. 
Массив С отсортировать по убыванию, используя алгоритмы сортировок: сортировка Шелла,  «пузырек». */
...
int main()
{
	...
	for (int i = 0; i < arrayC.size() - 1; i++) {
		for (int j = 0; j < arrayC.size() - i - 1; j++) {
	...
	{
		for (int i = step; i < arrayC.size(); i++)
		{
